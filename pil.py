...
async def resize_100(image):
    ...
    image.save(f"C:/Users/Пользователь/PycharmProjects/stickerformat_conversion_bot/photo/{image_name}.png",
               format="PNG")
    return image_name
...
async def remove_bg(image):
    ...
    image_name = secrets.token_hex(8)
    output_image.save(f"C:/Users/Пользователь/PycharmProjects/stickerformat_conversion_bot/photo/{image_name}.png",
                      format="PNG")
    return image_name
